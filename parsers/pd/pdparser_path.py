...
def generate_path(pp):
    ...
    # create a dictionary of all the objects where key is the box["id"] and value is the box["object_type"]"
    object_dict = {}
    for obj in objects:
        object_dict[obj["box"]["id"]] = obj["box"]["object_type"]
    

    # write code to get the source and destination from each patchline in connections
    ...
    if len(connections) > 0:
        ...
        # the following code is collected from 
        # https://stackoverflow.com/a/55847850 and
        # https://stackoverflow.com/a/74176726
        ...
        for root in roots :
            for leaf in leaves :
                for path in nx.all_simple_paths(G, root, leaf, 7) :
